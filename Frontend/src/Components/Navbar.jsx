...
function Navbar() {
 ...
 useEffect(()=>{
  ...
  sticky ? "sticky top-0 z-50 shadow-md bg-base-200 dark:bg-slate-600 transition-all duration-300 ease-in-out" : "fixed top-0 left-0 right-0 z-50"
}`}>
        ...
        <div className="navbar ">
          ...
          {/* Navbar end with search bar and login button */}
          <div className="navbar-end flex items-center space-x-3">
            {/* Search bar hidden on small screens */}
            <div className="hidden md:flex items-center">
              <label className="input input-bordered flex items-center">
                <input type="text" className="grow outline-non dark:bg-slate-900 dark:text-white" placeholder="Search" />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 16 16"
                  fill="currentColor"
